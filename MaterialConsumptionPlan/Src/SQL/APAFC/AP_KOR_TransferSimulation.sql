...
WHERE BUDATPOSTINGDATE BETWEEN TO_CHAR(SYSDATE - 375) AND TO_CHAR(SYSDATE)
...
SELECT MATERIALID
            ...
            AND VERSBP_VERSION = '00' AND PLANTID = '5100' AND
            MATERIALID IN ('PN-233443',
'PN-233540',
'PN-233537',
'PN-233446',
'150-C85NBD B',
...
SELECT * FROM INV_SAP_SALES_HST WHERE PLANTID = '5100' AND MATERIALID IN ('PN-233443',
'PN-233540',
'PN-233537',
'PN-233446',
'150-C85NBD B',
...
SELECT * FROM INV_SAP_SALES_HST WHERE PLANTID = '' AND MATERIALID IN ('PN-233443',
'PN-233540',
'PN-233537',
'PN-233446',
'150-C85NBD B',
