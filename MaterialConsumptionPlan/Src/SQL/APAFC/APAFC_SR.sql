...
SELECT RE_BSVSTGSR.ID            AS ID,
  ...
  RE_BSVSTGSR.PREFERRED_PRODUCT  AS PREFERRED_PRODUCT,
...
FROM
  (SELECT RE_BSVSTGS.ID           AS ID,
    ...
    RE_BSVSTGS.PREFERRED_PRODUCT  AS PREFERRED_PRODUCT,
  ...
  FROM
    (SELECT RE_BSVSTG.ID           AS ID,
      ...
      RE_BSVSTG.PREFERRED_PRODUCT  AS PREFERRED_PRODUCT,
    ...
    FROM
      (SELECT RE_BSVST.ID           AS ID,
        ...
        RE_BSVST.PREFERRED_PRODUCT  AS PREFERRED_PRODUCT,
...
SELECT COUNT(*) FROM
(select DISTINCT MATERIALID,DIRECT_SHIP_PLANT  from inv_sap_pp_mvke where DIRECT_SHIP_PLANT IN ('5040') AND PREFERRED_PRODUCT = 'X')
...
--BK
CREATE VIEW VIEW_INV_SAP_SCH_RECA
SELECT RE_BSVSTGSR.ID            AS ID,
  RE_BSVSTGSR.CUST_RE_PLANT      AS CUST_RE_PLANT,
  RE_BSVSTGSR.CUST_RE_MATL       AS CUST_RE_MATL,
  RE_BSVSTGSR.CUST_RE_QTY        AS CUST_RE_QTY,
...
ON RE_BSVSTGSR.ID = DSTR_STATS.ID;
  ...
  CREATE OR REPLACE FORCE VIEW "SYSTEM"."VIEW_INV_SAP_SCH_REMATL" ("ID", "CUST_RE_PLANT", "CUST_RE_MATL", "CUST_RE_QTY", "CUST_RE_SER", "CUST_RE_PRICE", "CUST_RE_AMOUNT", "SOG", "CUST_REMARK", "RE_MATERIAL", "RE_PLANT", "RE_D_CHAIN_BLK", "RE_UNIT_COST", "RE_DELIVERY_UNIT", "RE_STRATEGY_GRP", "RE_OH_QTY", "RE_VENDOR", "RE_MATL_TYPE", "RE_VENDOR_ITEM", "RE_ULTIMATE_SOURCE", "VP_STRATEGY_GRP", "VP_OH_QTY", "VP_Q4_SUM", "Q1_SHIP_QTY", "Q2_SHIP_QTY", "Q3_SHIP_QTY", "Q4_SHIP_QTY", "Q1_LN_QTY", "Q2_LN_QTY", "Q3_LN_QTY", "Q4_LN_QTY", "MAX_DIS_NAME", "MAX_DIS_USAGE_QTY", "TOT_USAGE_QTY", "PER_BIGGEST", "DISTRIBUTOR_COUNT", "ALLOW_RETURN_FLG", "SG_CHECK", "SERISES", "EX_TO_USD") AS 
  SELECT RE_BSVSTGSR.ID            AS ID,
  RE_BSVSTGSR.CUST_RE_PLANT      AS CUST_RE_PLANT,
  RE_BSVSTGSR.CUST_RE_MATL       AS CUST_RE_MATL,
  RE_BSVSTGSR.CUST_RE_QTY        AS CUST_RE_QTY,
