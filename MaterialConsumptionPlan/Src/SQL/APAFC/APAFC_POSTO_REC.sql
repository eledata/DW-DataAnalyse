...
SELECT COUNT(*) FROM(
(SELECT DISTINCT PLANTid, MATERIALID,STRATEGY_GRP FROM INV_SAP_PP_OPTIMIZATION WHERE PLANTid IN ('5040','5050'))PP
LEFT JOIN
(SELECT * FROM INV_SAP_MATERIAL_CATALOG)CAT
ON CAT.MATERIALID = PP.MATERIALID
)
