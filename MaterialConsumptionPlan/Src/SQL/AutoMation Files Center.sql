...
1. Oracle Client Setup
    ...
    CREATE TABLE INV_SAP_PP_PO_HISTORY_ALL AS SELECT * FROM DWQ$LIBRARIAN.INV_SAP_PP_PO_HISTORY@ROCKWELL_DW_DBLINK;
		...
		SELECT * FROM DWQ$LIBRARIAN.INV_SAP_SALES_HST@ROCKWELL_DW_DBLINK WHERE salesdoc = '6000759915';
...
SELECT MATERIALID, SALES_ORG, D_CHAIN_BLK FROM INV_SAP_PP_MVKE WHERE SALES_ORG IN ('5003','5007');


select * from INV_SAP_PP_MVKE where materialid = '0018-3503';
2. Oracle Job Setup
...
4.2 Job Name: Job_Monthly_INV_PP_CATA
    ...
    SELECT CATALOG_STRING1 FROM DWQ$LIBRARIAN.INV_SAP_MATERIAL_CATALOG;
...
SELECT * FROM INV_SAP_MATERIAL_CATALOG where CATALOG_STRING1 = '1734-4IOL';
