...
1. Oracle Client Setup
    ...
    select * from INV_SAP_PP_PO_HISTORY where materialid = '22C-D260A103 A'
...
--Daily Jobs
    ...
    SELECT MATERIALID||'_'||PLANTID AS ID, OH_QTY FROM INV_SAP_INVENTORY_BY_PLANT WHERE MATERIALID = 'PN-184723' AND PLANTID = '5040';
