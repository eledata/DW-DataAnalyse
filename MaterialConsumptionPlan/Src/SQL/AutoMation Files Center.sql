...
1. Oracle Client Setup
    ...
    SELECT * FROM INV_SAP_SALES_HST_LC WHERE PLANT = '5040';
...
SELECT distinct prod_bu FROM INV_SAP_PP_OPT_X WHERE STRATEGY_GRP = '40' AND PLANT IN  ('5040', '5050', '5100', '5110', '5120', '5160', '5190', '5200','5070','5140');
...
select * from INV_SAP_SALES_HST;
  ...
  SELECT * FROM INV_SAP_INV_REC WHERE PLANTid = '5040' AND MATERIAL = '81001-450-53-R' AND REC_DATE BETWEEN TO_CHAR(SYSDATE-8) AND TO_CHAR(SYSDATE +3)
