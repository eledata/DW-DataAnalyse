...
select count(*) from INV_SAP_RCCP_INDREQ_THU;
SELECT * FROM VIEW_INV_SAP_RCCP_THU_TMP WHERE ID = 'PN-130651_5040';
  ...
  LEFT JOIN
    ...
    FROM
      (SELECT ID,
        ...
        END WEEK_10,
        CASE
          WHEN WEEK_NUMBER = TO_CHAR(SYSDATE,'iw') - 42
          THEN OPEN_PO_QTY
          ELSE 0
        END WEEK_11,
        CASE
          WHEN WEEK_NUMBER = TO_CHAR(SYSDATE,'iw') - 41
          THEN OPEN_PO_QTY
          ELSE 0
        END WEEK_12,
        CASE
          WHEN WEEK_NUMBER = TO_CHAR(SYSDATE,'iw') - 40
          THEN OPEN_PO_QTY
          ELSE 0
        END WEEK_13
      FROM
...
SELECT * FROM VIEW_INV_SAP_RCCP_THU_TMP WHERE ID = 'PN-193342_5040'
...
ON BS_MCBZ_PO.ID = OPEN_PLAN.ID;
  ...
  CREATE OR REPLACE FORCE VIEW "SYSTEM"."VIEW_INV_SAP_RCCP_THU_TMP" ("ID", "MATERIAL", "CATALOG_DASH", "PLANT", "MATERIAL_DES", "MRP_CONTROLLER", "MRP_TYPE", "STRATEGY_GRP", "SAFETY_STOCK", "OH_QTY", "UNIT", "UNIT_COST", "PROD_BU", "PRODUCTION_PLANT", "VENDOR", "MIN_INV", "TARGET_INV", "MAX_INV", "IND_REQ_AVG", "IND_REQ_AVG_50", "IND_REQ_AVG_25", "IND_REQ_WEEK_0", "IND_REQ_WEEK_1", "IND_REQ_WEEK_2", "IND_REQ_WEEK_3", "IND_REQ_WEEK_4", "IND_REQ_WEEK_5", "IND_REQ_WEEK_6", "IND_REQ_WEEK_7", "IND_REQ_WEEK_8", "IND_REQ_WEEK_9", "IND_REQ_WEEK_10", "IND_REQ_WEEK_11", "IND_REQ_WEEK_12", "FIRM_REQ_WEEK_0", "FIRM_REQ_WEEK_1", "FIRM_REQ_WEEK_2", "FIRM_REQ_WEEK_3", "FIRM_REQ_WEEK_4", "FIRM_REQ_WEEK_5", "FIRM_REQ_WEEK_6", "FIRM_REQ_WEEK_7", "FIRM_REQ_WEEK_8", "FIRM_REQ_WEEK_9", "FIRM_REQ_WEEK_10", "FIRM_REQ_WEEK_11", "FIRM_REQ_WEEK_12", "TOT_REQ_WEEK_0", "TOT_REQ_WEEK_1", "TOT_REQ_WEEK_2", "TOT_REQ_WEEK_3", "TOT_REQ_WEEK_4", "TOT_REQ_WEEK_5", "TOT_REQ_WEEK_6", "TOT_REQ_WEEK_7", "TOT_REQ_WEEK_8", "TOT_REQ_WEEK_9", "TOT_REQ_WEEK_10", "TOT_REQ_WEEK_11", "TOT_REQ_WEEK_12", "THREE_SIGMA", "THREE_SIGMA_LOAD", "TOT_PO_PLO_WEEK_0", "TOT_PO_PLO_WEEK_1", "TOT_PO_PLO_WEEK_2", "TOT_PO_PLO_WEEK_3", "TOT_PO_PLO_WEEK_4", "TOT_PO_PLO_WEEK_5", "TOT_PO_PLO_WEEK_6", "TOT_PO_PLO_WEEK_7", "TOT_PO_PLO_WEEK_8", "TOT_PO_PLO_WEEK_9", "TOT_PO_PLO_WEEK_10", "TOT_PO_PLO_WEEK_11", "TOT_PO_PLO_WEEK_12", "OPEN_OP_WEEK_0", "OPEN_OP_WEEK_1", "OPEN_OP_WEEK_2", "OPEN_OP_WEEK_3", "OPEN_OP_WEEK_4", "OPEN_OP_WEEK_5", "OPEN_OP_WEEK_6", "OPEN_OP_WEEK_7", "OPEN_OP_WEEK_8", "OPEN_OP_WEEK_9", "OPEN_OP_WEEK_10", "OPEN_OP_WEEK_11", "OPEN_OP_WEEK_12", "PLAN_OP_WEEK_0", "PLAN_OP_WEEK_1", "PLAN_OP_WEEK_2", "PLAN_OP_WEEK_3", "PLAN_OP_WEEK_4", "PLAN_OP_WEEK_5", "PLAN_OP_WEEK_6", "PLAN_OP_WEEK_7", "PLAN_OP_WEEK_8", "PLAN_OP_WEEK_9", "PLAN_OP_WEEK_10", "PLAN_OP_WEEK_11", "PLAN_OP_WEEK_12", "KEY") AS 
  SELECT BS_MCBZ_PO.ID                                                                                                                                                                                                                                                                                                                                                                                                                                AS ID,
    BS_MCBZ_PO.MATERIAL                                                                                                                                                                                                                                                                                                                                                                                                                               AS MATERIAL,
    BS_MCBZ_PO.CATALOG_DASH                                                                                                                                                                                                                                                                                                                                                                                                                           AS CATALOG_DASH,
    BS_MCBZ_PO.PLANT                                                                                                                                                                                                                                                                                                                                                                                                                                  AS PLANT,
