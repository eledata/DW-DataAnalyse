...
SELECT * FROM INV_SAP_SALES_HST WHERE PLANTID IN (
'5040','5050') AND LINECREATIONDATE BETWEEN TO_CHAR(SYSDATE - 500) AND TO_CHAR(SYSDATE) AND SOLDTOPARTY IN ('30408609','594921','7712751','91312325')
...
SELECT * FROM INV_SAP_SALES_HST WHERE SALESDOC = '6501998298'