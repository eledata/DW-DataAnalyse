...
SELECT * FROM INV_SAP_SVD_COMMENTS_TMP;
...
INTO INV_SAP_SVD_COMMENTS_TMP
  ...
  (
    'PN-106982_5190',
    'Out of stock at 1180. Next available date end Nov 14.',
    'Moe',
    SYSDATE
  )
  ...
  PN-258585_5070
  SELECT * FROM INV_SAP_SVD_COMMENTS_TMP where id = 'PN-258585_5070';
...
INTO INV_SAP_SVD_COMMENTS_TMP
  ...
  (
    'PN-258585_5070',
    'Redundancy Bundle. Issue with one of the components',
    'Barath',
    '21-Aug-15'
  )
---
--1.Add the Inv infomation in the stock item metric.
--2.Only add the Inv value in the chart.

SELECT * FROM VIEW_INV_SAP_INV_REC_STATUS
