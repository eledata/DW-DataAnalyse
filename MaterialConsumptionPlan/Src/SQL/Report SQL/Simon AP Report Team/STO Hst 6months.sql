...
select * from VIEW_INV_SAP_STO_HST_6MMS where plant = '5040'
...
SELECT 
        ...
        UNIT_COST                  AS UNIT_COST
      FROM INV_SAP_PP_PO_HISTORY 
      WHERE PLANTID             IN ('5040', '5050', '5110')
...
WHERE LIFNR_VENDORNO <> 'V5110'


SELECT * FROM INV_SAP_PP_PO_HISTORY WHERE LIFNR_VENDORNO = '2089088' AND PLANTID = '5040'

22C-D017N103 A

SELECT * FROM INV_SAP_PP_PO_HISTORY 
      WHERE PLANTID             IN ('5040', '5050')      AND BEDATSCHEDULELINEORDERDATE BETWEEN TO_CHAR(SYSDATE - 400) AND TO_CHAR(SYSDATE)